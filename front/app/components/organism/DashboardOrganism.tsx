  ...
  return (
    <div className="flex flex-col gap-8 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {isLoading || !summary ? (
          <>
            <div className="h-90 rounded-lg border-2 border-primary-purple/30 bg-white dark:bg-dark-surface animate-pulse" />
            <div className="h-90 rounded-lg border-2 border-primary-purple/30 bg-white dark:bg-dark-surface animate-pulse" />
          </>
        ) : (
          <>
            {hasCategoryData ? (
              ...
              <div className="rounded-lg border-2 border-primary-purple/40 dark:border-primary-purple bg-white dark:bg-dark-surface p-6 flex items-center justify-center min-h-50 shadow-sm">
