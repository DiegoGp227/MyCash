...
export default function GraphsOrganism({ summary, isLoading }: GraphsOrganismProps) {
  if (isLoading || !summary) {
    return (
      <div className="h-90 rounded-lg border-2 border-primary-purple/30 bg-white dark:bg-dark-surface animate-pulse w-full" />
    );
  }
  ...
  if (!hasTransactions) {
    return (
      <div className="rounded-lg border-2 border-primary-purple/40 dark:border-primary-purple bg-white dark:bg-dark-surface p-6 flex items-center justify-center min-h-50 w-full shadow-sm">
